...
waste15 = Waste.create(name: 'Starbucks coffee lid', category: 'recycle')
waste16 = Waste.create(name: 'Plastic water bottle', category: 'recycle')
waste17 = Waste.create(name: 'Starbucks coffee cup', category: 'recycle')
waste18 = Waste.create(name: 'Soda can', category: 'recycle')
waste19 = Waste.create(name: 'Plastic bags', category: 'recycle')
waste20 = Waste.create(name: 'Wine bottle', category: 'recycle')
